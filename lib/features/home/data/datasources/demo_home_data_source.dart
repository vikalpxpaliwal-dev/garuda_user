...
/// Bundled home dashboard used only when [HomeDataConfig.useDemoHome] is true.
abstract interface class DemoHomeDataSource {
  Future<HomeDashboardModel> getHomeDashboard();
}

class DemoHomeDataSourceImpl implements DemoHomeDataSource {
  @override
